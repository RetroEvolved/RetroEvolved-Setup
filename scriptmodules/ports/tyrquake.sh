...
rp_module_licence="GPL2 https://raw.githubusercontent.com/RetroEvolved/tyrquake/master/gnu.txt"
...
function sources_tyrquake() {
    gitPullOrClone "$md_build" https://github.com/RetroEvolved/tyrquake.git
}
