...
rp_module_licence="OTHER https://raw.githubusercontent.com/RetroEvolved/zdoom/master/docs/licenses/README.TXT"
...
function sources_zdoom() {
    gitPullOrClone "$md_build" https://github.com/RetroEvolved/zdoom.git retroevolved
}
