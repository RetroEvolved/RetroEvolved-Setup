...
rp_module_licence="GPL2 https://raw.githubusercontent.com/RetroEvolved/daphne-emu/master/COPYING"
...
function sources_daphne() {
    gitPullOrClone "$md_build" https://github.com/RetroEvolved/daphne-emu.git retroevolved
}
