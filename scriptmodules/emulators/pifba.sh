...
rp_module_licence="GPL2 https://raw.githubusercontent.com/RetroEvolved/pifba/master/FBAcapex_src/COPYING"
...
function sources_pifba() {
    gitPullOrClone "$md_build" https://github.com/RetroEvolved/pifba.git
}
