...
rp_module_licence="NONCOM https://raw.githubusercontent.com/RetroEvolved/mame4all-pi/master/readme.txt"
...
function sources_mame4all() {
    gitPullOrClone "$md_build" https://github.com/RetroEvolved/mame4all-pi.git
}
