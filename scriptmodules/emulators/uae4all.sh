...
rp_module_licence="GPL2 https://raw.githubusercontent.com/RetroEvolved/uae4all2/retroevolved/copying"
...
function sources_uae4all() {
    gitPullOrClone "$md_build" https://github.com/RetroEvolved/uae4all2.git retroevolved
    mkdir guichan
