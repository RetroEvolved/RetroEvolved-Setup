...
rp_module_licence="GPL2 https://raw.githubusercontent.com/RetroEvolved/osmose-rpi/master/license.txt"
...
function sources_osmose() {
    gitPullOrClone "$md_build" https://github.com/RetroEvolved/osmose-rpi.git
}
