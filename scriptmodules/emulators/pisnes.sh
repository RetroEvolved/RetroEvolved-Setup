...
rp_module_licence="NONCOM https://raw.githubusercontent.com/RetroEvolved/pisnes/master/snes9x.h"
...
function sources_pisnes() {
    gitPullOrClone "$md_build" https://github.com/RetroEvolved/pisnes.git
}
