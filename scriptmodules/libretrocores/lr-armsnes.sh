...
rp_module_licence="NONCOM https://raw.githubusercontent.com/RetroEvolved/ARMSNES-libretro/master/src/snes9x.h"
rp_module_section="opt"
rp_module_flags="!x86 !aarch64"

function sources_lr-armsnes() {
    gitPullOrClone "$md_build" https://github.com/RetroEvolved/ARMSNES-libretro
}
