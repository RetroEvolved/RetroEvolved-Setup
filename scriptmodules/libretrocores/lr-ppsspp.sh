...
rp_module_licence="GPL2 https://raw.githubusercontent.com/RetroEvolved/ppsspp/master/LICENSE.TXT"
...
function sources_lr-ppsspp() {
    if isPlatform "rpi"; then
        gitPullOrClone "$md_build" https://github.com/RetroEvolved/ppsspp.git libretro_rpi_fix
    else
