...
function _add_system_mehstation() {
    ...
    NAME="$fullname" COMMAND="$command" DIR="$path" EXTS="$extensions" "/opt/retroevolved/supplementary/mehstation/bin/mehtadata" -db="$db" -new-platform
}
...
function _del_system_mehstation() {
    ...
    PLATFORM_NAME="$fullname" "/opt/retroevolved/supplementary/mehstation/bin/mehtadata" -db="$db" -del-platform
}
...
function _add_rom_mehstation() {
    ...
    NAME="$4" FILEPATH="$path" PLATFORM_NAME="$system_fullname" DESCRIPTION="$desc" "/opt/retroevolved/supplementary/mehstation/bin/mehtadata" -db="$db" -new-exec

    RESOURCE="$image" FILEPATH="$path" PLATFORM_NAME="$system_fullname" TYPE="cover" "/opt/retroevolved/supplementary/mehstation/bin/mehtadata" -db="$db" -new-res
}
