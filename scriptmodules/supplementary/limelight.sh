...
function sources_limelight() {
    gitPullOrClone "$md_build" "https://github.com/stsfin/RetroevolvedLimelightInstaller.git"
    ...
    wget https://github.com/stsfin/RetroevolvedLimelightInstaller/releases/download/1.3.1/theme.xml
    wget https://github.com/stsfin/RetroevolvedLimelightInstaller/releases/download/1.3.1/limelight.png
    wget https://github.com/stsfin/RetroevolvedLimelightInstaller/releases/download/1.3.1/limelight_art.png
    wget https://github.com/stsfin/RetroevolvedLimelightInstaller/releases/download/1.3.1/limelight_art_blur.png
}
...
#!/bin/bash
sudo $scriptdir/retroevolved_packages.sh limelight configure
_EOF_
