...
function gui_esthemes() {
    local themes=(
        'RetroEvolved carbon'
        'RetroEvolved carbon-centered'
        'RetroEvolved carbon-nometa'
        'RetroEvolved simple'
        'RetroEvolved simple-dark'
        'RetroEvolved clean-look'
        'RetroEvolved color-pi'
        'RetroEvolved nbba'
        'RetroEvolved simplified-static-canela'
        'RetroEvolved turtle-pi'
        'RetroEvolved zoid'
        'ehettervik pixel'
