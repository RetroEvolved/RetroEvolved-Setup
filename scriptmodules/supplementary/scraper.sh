...
rp_module_desc="Alternative Scraper for EmulationStation by Steven Selph"
...
function scrape_scraper() {
    ...
    # trap ctrl+c and return if pressed (rather than exiting retroevolved-setup etc)
