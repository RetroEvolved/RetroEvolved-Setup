...
function sources_sdl1() {
    ...
    cd libsdl1.2-1.2.15
    # add fixes from https://github.com/RetroEvolved/sdl1/compare/master...rpi
    wget https://github.com/RetroEvolved/sdl1/compare/master...rpi.diff -O debian/patches/rpi.diff
    ...
    DEBEMAIL="Jools Wills <buzz@exotica.org.uk>" dch -v $(get_pkg_ver_sdl1) "Added rpi fixes and dispmanx support from https://github.com/RetroEvolved/sdl1/compare/master...rpi"
}
